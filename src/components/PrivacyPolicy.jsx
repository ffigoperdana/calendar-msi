  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <section className="mb-8">
        ...
        <p className="mb-3">
          Calendar MSI ("we", "our", "the app") is a calendar management tool built for internal use at PT Mitra Solusi Infokom. This privacy policy explains how we handle your information when you use our application.
        </p>
      </section>
